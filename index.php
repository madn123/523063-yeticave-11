...
<main class="container">
    <section class="promo">
        ...
        <ul class="promo__list">
        	<!-- Я бы хотел сделать вывод категорий через цикл foreach, но не смог понять как через него обращаться к простому массиву -->
        	<?php
			$index = 0;
			$num = count($cats);
			while ($index < $num): ?>
        ...
        <ul class="lots__list">
        	<?php foreach ($products as $key => $value): ?>
	            <li class="lots__item lot">
	                ...
	                <div class="lot__info">
	                    <span class="lot__category"><?=$value['cats']; ?></span>
